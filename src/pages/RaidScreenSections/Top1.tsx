...
export const Top1 = (): JSX.Element => {
  return (
    // TOP-1
    <div className="bg-gradient-to-b from-[rgba(48,48,48,1)] to-[rgba(27,27,27,1)] border-b border-black h-[144px] w-full relative">
      <div className="relative w-full max-w-[393px] mx-auto h-full">
        {/* element-hga-wrapper */}
        <div
