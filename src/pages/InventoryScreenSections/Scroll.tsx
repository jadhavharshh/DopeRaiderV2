...
export const Scroll = (): JSX.Element => {
  return (
    <div className="px-4 w-full h-full flex justify-center">
      <div className="font-['Roboto_Condensed'] h-[439px] overflow-hidden overflow-y-scroll max-w-[362px] min-w-[320px] mx-auto align-center justify-center scrollbar-hide">
        <div className="h-[469px] relative top-4 w-full max-w-[362px] min-w-[320px] px-4 sm:px-0">
          {/* AIRDROP Section */}
