  ...
  return (
    <div className="min-h-screen w-full bg-black overflow-hidden">
      ...
      <div className="relative w-full h-screen overflow-hidden md:hidden">
        ...
        {/* PRODUCTION Title - Centered with Flexbox */}
        <div className="relative w-full flex justify-center items-center pt-[59px] z-20">
        ...
        <div className="absolute w-[208px] h-[42px] left-[calc(50%-208px/2+1.5px)] top-[150px] z-20">
        ...
        {/* Left Production Card - GROW WEED */}
        <div
          className="absolute w-[176px] h-[298px] left-[calc(50%-176px/2-92.5px)] top-[210px] rounded-[4px] flex flex-col items-center pt-[15px] px-[15px] pb-0 z-20"
          style={{
        ...
        <div className="absolute w-[176px] h-[298px] left-[calc(50%-176px/2+92.5px)] top-[210px] border border-[#6e6b67] border-opacity-40 rounded-[4px] flex flex-col items-center pt-[15px] px-[15px] pb-0 z-20" style={{ background: 'rgba(0, 0, 0, 0.7)', backdropFilter: 'blur(10px)' }}>
          {/* COKE Header */}
          <div className="flex items-center justify-center gap-[8px] w-full h-[24px] mb-[15px]">
            {/* Icon */}
            <div className="relative w-[24px] h-[24px]">
